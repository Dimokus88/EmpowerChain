...
# Нода валидатора сети EmPower, развертка в Akash Network.
...
| [Discord EmPower](https://discord.gg/9AVrbea6RN) | [Explorer EmPower](https://testnet-empower.zenscan.io/index.php) | [Site EmPower](https://empowerchain.io/) | [Twitter EmPower](https://twitter.com/empowerchain_io) |
|:--:|:--:|:--:|:--:|
...
You can delegate the remaining tokens to yourself, but leave 1,000,000 umpwr to pay for transaction gas:
...
Можете делегировать на себя оставшиеся токены, но оставьте 1 000 000 umpwr для оплаты газа транзакций:
